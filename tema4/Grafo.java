...
public interface Grafo<T> {
    ...
    // Con Depth-First Search (DFS): recorrer avanzando lo más profundo posible por cada camino antes de retroceder. Es decir, seguir un nodo → luego uno de sus hijos → luego un hijo de ese hijo… hasta que no haya más, y recién ahí volver atrás y probar otro camino.
